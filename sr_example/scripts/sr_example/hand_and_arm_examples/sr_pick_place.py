...
while not rospy.is_shutdown():
    wait_for_topic()
    arm_commander.move_to_named_target("arm_pre_bracket", False)
    hand_commander.move_to_named_target("hand_pre_bracket", False)
    wait_for_topic()
    arm_commander.move_to_named_target("arm_grasp_bracket", False)
    wait_for_topic()
    hand_commander.move_to_named_target("hand_grasp_bracket", True)
    wait_for_topic()
    arm_commander.move_to_named_target("arm_pre_bracket", False)
    wait_for_topic()
    arm_commander.move_to_named_target("arm_pre_place_bracket", False)
    wait_for_topic()
    arm_commander.move_to_named_target("arm_place_bracket", False)
    wait_for_topic()
    hand_commander.move_to_named_target("hand_pre_bracket", False)
    wait_for_topic()
    arm_commander.move_to_named_target("arm_pre_place_bracket", False)
